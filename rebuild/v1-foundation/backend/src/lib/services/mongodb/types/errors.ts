...
export class MongoDBServiceError extends Error {
  ...
  constructor(message: string, operation?: string, originalError?: Error, code?: string | number) {
    super(message);
...
export class MongoWriteError extends Error {
  ...
  constructor(message: string, code?: number, index?: number, operation?: string, collection?: string) {
    super(message);
...
export interface ErrorContext {
  ...
  timestamp?: Date;
  endpoint?: string;
  method?: string;  metadata?: Record<string, any>;
}
